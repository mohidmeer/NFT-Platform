...
const CreateCollection = ({ title = "List Your Collection " }) => {
  ...
  const PageDisplay = () => {
    if (page === 1) {
      return (
        <Intro stateChanger={setPage} setValues={setValues} values={values} />
      );
    } else if (page === 2) {
      return (
        <Collection
      ...
      return (
        <Detail stateChanger={setPage} setValues={setValues} values={values} />
      );
    } else if (page === 4) {
      return (
        <Socials stateChanger={setPage} setValues={setValues} values={values} />
      );
    } else if (page === 5) {
      return (
        <Background
