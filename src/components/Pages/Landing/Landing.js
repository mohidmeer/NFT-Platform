...
const Landing = () => {
  return (
    <>
      <div className=" p-4  ">
        <div className="lg:px-24 px-0         p-4  lg:pb-8  border-b-2 border-white  mt-8">
          {" "}
          <Hero />{" "}
        </div>
        <div className="lg:px-24 px-0   rounded-xl      p-4  lg:pb-8  border-2 border-white  mt-8">
          {" "}
          <SocialMediaApi />{" "}
        </div>
        {/* <div className='mt-8 border-2  rounded-xl p-4 lg:pb-8 border-white '> <CreatorCommunities /> </div> */}
        <div className="mt-24 border-2 rounded-xl      p-4 lg:pb-8 border-white ">
          <PopularCollection name={"Our Collections"} />
        </div>
        <div className="mt-24 border-2 rounded-xl      p-4 lg:pb-8 border-white ">
          <PopularCollection name={"Trending Collections"} />
        </div>
        <div className="mt-8 border-2 rounded-xl  p-4 lg:pb-8 border-white ">
          {" "}
          <Auctions />{" "}
        </div>
        <div className="mt-16 border-2   rounded-xl    p-4 lg:pb-8 border-white ">
          <LaunchPadDrops />
        </div>
        <div className="mt-8 border-2 rounded-xl  p-4 lg:pb-8 border-white ">
          {" "}
          <WhitelistOppurtunities />{" "}
        </div>
        <div className="mt-8 border-2  rounded-xl p-4 lg:pb-8 border-white ">
          {" "}
          <Youtube />{" "}
