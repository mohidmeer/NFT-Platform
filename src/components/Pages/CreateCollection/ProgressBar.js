  ...
  return (
    <div class=" mx-auto my-4 border-b-2 pb-4">
      <div class="flex pb-3">
        <div class="flex-1">
          <div
            ...
            class="w-10 h-10 bg-pink-600 mx-auto rounded-full text-lg text-white flex items-center"
          >
        ...
        <div class="w-1/6 align-center items-center align-middle content-center flex">
          <div class="w-full bg-grey-light rounded items-center align-middle align-center flex-1">
            <div
              className={` ${
                page == 2 || page > 2 ? "bg-pink-600 " : " bg-gray-300"
              }   w-full text-xs leading-none py-1 text-center text-grey-darkest rounded `}
            ></div>
          </div>
        </div>
        <div class="flex-1">
          <div
            ...
            className={` ${
              page == 2 || page > 2
                ...
                : "bg-white text-black"
            }  w-10 h-10  border mx-auto rounded-full text-lg text-white flex items-center`}
          >
        ...
        <div class="w-1/6 align-center items-center align-middle content-center flex">
          <div class="w-full bg-grey-light rounded items-center align-middle align-center flex-1">
            <div
              className={` ${
                page == 3 || page > 3 ? "bg-pink-600" : "bg-gray-300"
              }  w-full text-xs leading-none py-1 text-center text-grey-darkest rounded `}
            ></div>
          </div>
        </div>
        ...
        <div class="w-1/6 align-center items-center align-middle content-center flex">
          <div class="w-full bg-grey-light rounded items-center align-middle align-center flex-1">
            <div
              className={` ${
                page == 4 || page > 4 ? "bg-pink-600" : "bg-gray-300"
              }  w-full text-xs leading-none py-1 text-center text-grey-darkest rounded `}
            ></div>
          </div>
        </div>
        ...
        <div class="w-1/6 align-center items-center align-middle content-center flex">
          <div class="w-full bg-grey-light rounded items-center align-middle align-center flex-1">
            <div
              className={` ${
                page == 5 || page > 5 ? "bg-pink-600" : "bg-gray-300"
              }  w-full text-xs leading-none py-1 text-center text-grey-darkest rounded `}
            ></div>
          </div>
        </div>
        ...
        <div class="w-1/6 align-center items-center align-middle content-center flex">
          <div class="w-full bg-grey-light rounded items-center align-middle align-center flex-1">
            <div
              className={` ${
                page == 6 ? "bg-pink-600" : "bg-gray-300"
              }  w-full text-xs leading-none py-1 text-center text-grey-darkest rounded `}
            ></div>
          </div>
        </div>
        ...
        <div class="flex-1">
          <div
            ...
            className={` ${
              page == 6 ? "bg-pink-600 text-white" : "bg-white text-black"
            }  w-10 h-10  border mx-auto rounded-full text-lg text-white flex items-center`}
          >
      ...
      <div class="grid gap-x-4	grid-cols-6 ">
        ...
        <div class="font-bold  text-center ml-8 ">Socials</div>

        <div class="font-bold  text-right mr-6">Background</div>
        <div class="font-bold  text-right">Launch</div>
      </div>
    </div>
  );
};
