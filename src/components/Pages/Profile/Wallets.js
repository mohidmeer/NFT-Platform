   ...
   <div class="max-w-[574px] rounded-[20px] p-6 mt-6 border border-solid border-gray-300">
      <div>
         ...
         <div class="flex justify-between mt-4 flex-col sm:flex-row gap-2">
            ...
            <button type="button" class=" bg-pink-600 w-1/2 inline-flex justify-center items-center rounded-md text-white">Link wallet</button>
         </div>
      </div>
            ...
            <li class="flex justify-between">
               <div class="flex flex-col gap-2">
                  <div class="flex flex-wrap gap-2">
                     <span class="font-bold break-all">0x6baa2C243211E7F470C12E843696352b2Ba40500</span>
                     <div><span class="border rounded px-[5px] py-1 mx-2 inline-flex items-center text-white-2 text-center leading-none uppercase border-green-700 text-white font-bold bg-green-600/75 ">ACTIVE</span></div>
                  </div>
                  <div>Etherium</div>
               </div>
            </li>
