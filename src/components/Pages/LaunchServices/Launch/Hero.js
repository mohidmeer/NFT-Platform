  ...
  return (
    <div class="flex flex-1 flex-col-reverse md:flex-row mx-auto gap-8 justify-between">
           <div class="flex flex-col gap-4 flex-grow md:max-w-[40%]">
              ...
              <h1 class="mt-1 text-[58px] font-extrabold leading-none">Syberais: Mint Scrolls</h1>
              <div class="inline-flex gap-2 content-center w-fit-content flex-wrap">
                 ...
                 <div class="flex items-center gap-2">
                    ...
                    <div class="" data-tooltipped="" aria-describedby="tippy-tooltip-3" >
                       <a href="https://twitter.com/SyberaisNFT" target="_blank" rel="noreferrer" class="flex items-center">
              ...
              <div class="mb-4 text-light-gray-500">
                 ...
                 <p class="text-light-gray-500 mb-3 text-xl font-bold ">Syberais is a journey into innovation. Seasonal Utility, Manual Reveal &amp; partnered with an AAA Art Studio to create one of the highest quality IPs in the industry.</p>
              </div>
                 ...
                 <div class="" data-tooltipped="" aria-describedby="tippy-tooltip-8" data-original-title="Whitelist" >
                    <div class="rounded-xl border border-solid border-dark p-3 flex flex-col gap-6 hover:bg-purple-1 hover:cursor-help border-pink-600 " >
                       <div class="flex justify-between items-center">
                          ...
                          <div class="flex flex-row gap-2 tracking-wide items-center text-center flex-wrap justify-center text-pink-hot text-sm font-medium uppercase">
