...
const Card = () => {
  return (
    ...
    <img  width={400} className='rounded-xl' src="https://img-cdn.magiceden.dev/rs:fill:400:400:0:0/plain/https://bafybeiecbnwxqtasgaowivu3b7xqjmvc44amxdcvjo3rmxxcgprm63bdby.ipfs.dweb.link/"/>
    </div>
    <p className='text-xl font-bold text-center'>Gobblers</p>
