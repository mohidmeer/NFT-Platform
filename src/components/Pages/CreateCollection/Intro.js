    ...
    <div className="w-1/3">
      ...
      <form onSubmit={() => stateChanger(2)}>
        ...
        >
          ...
          <RadioGroup.Option value="ethereum">
            {({ checked }) => (
              <span
                className={` ${
                  checked ? "dsa" : "das"
        ...
        {location.pathname === "/createwhitelist" ? (
        ...
        <div class="mb-6 mt-6">
          ...
          <p className="font-bold text-xs mb-2">
            Providing and eternal link allows Buyers to find out more about you
            and helps to promote your community efforts
          </p>
          <input
        ...
        <button
          type="submit"
          className=" mt-2 p-3 w-36 flex justify-center rounded-lg text-white font-bold text-sm bg-pink-600"
        >
          Lets Go
        </button>
      </form>
      ...
      <p className="font-bold text-gray-700 mt-2">
        By launching an NFT and or Collection on our Marketplace you have read
        and agree to abide by our Term of Service and Privacy Policy
      </p>
      <small>
        Use of our website and Service are subject to our
        <a
          href="https://socialmint/terms-of-service.pdf"
        ...
        and
        <a
          href="https://socialmint/privacy-policy.pdf"
          class="font-bold text-pink-600"
        >
          Privacy Policy
        </a>
