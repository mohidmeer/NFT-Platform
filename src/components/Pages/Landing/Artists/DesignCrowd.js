...
import Auction from '../../../../Assets/Brands/design.png'
const DesignCrowd = () => {
  return (
    ...
    <img
      ...
      <div class="w-full text-sm  flex flex-col items-center rounded-b-xl mt-auto  ">
       ...
       <div className='flex justify-center  text-white '><MdAdd className='mt-1'/>  <span>DesignCrowd Connect</span> </div>
