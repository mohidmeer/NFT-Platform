...
const AuctionNft = ({ nftDetails, setNftDetails }) => {
          ...
          <label class="flex justify-center w-full h-32 px-4 transition  border-2 border-gray-400 border-dashed rounded-md appearance-none cursor-pointer hover:border-gray-500 focus:outline-none">
            <span class="flex items-center space-x-2">
              <span class="font-medium text-gray-600 text-center">
                PNG,GIF,MP4
                <br />
                <div class="text-pink-600  p-2 rounded-full mt-2 bg-white">
                  Choose File
                </div>
              </span>
            </span>
...
<div className="p-3">
  ...
  <p className="text-xs font-bold">Expiration Time:&nbsp; {exptime} </p>
      ...
      <div className="p-3">
        <div className="flex justify-between">
          <div>
            <p className="font-bold text-xl bg-gradient-to-r from-green-600 to-teal-500 bg-clip-text text-transparent">
              Unlock once purchased
            </p>
            <p className="text-xs">
              Content will be unlocked after successfull transtion
            </p>
          </div>
          <div>
            <label class="relative inline-flex items-center mr-5 cursor-pointer">
      ...
      <label class="relative inline-flex items-center mr-5 cursor-pointer">
        ...
        <div class="mb-4 ">
          ...
          <input
            ...
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  focus:border-pink-600 block w-full p-2.5  focus:outline-none"
            onChange={(e) =>
              setNftDetails({ ...nftDetails, minBidAmount: e.target.value })
            }
            required
          />
        </div>
